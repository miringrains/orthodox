...
const craftSchema = {
  ROOT: {
    ...
    custom: {},
    hidden: false,
    nodes: ['node-navbar', 'node-hero', 'node-feast', 'node-welcome', 'node-triptych', 'node-schedule', 'node-cta-bar', 'node-footer'],
    linkedNodes: {},
  },
  'node-navbar': {
  ...
  'node-footer': {
    ...
    nodes: [],
    linkedNodes: {
      'section-content': 'node-footer-content',
    },
  },
  'node-footer-content': {
    type: { resolvedName: 'ColumnCanvas' },
    ...
    parent: 'node-footer',
    hidden: false,
    nodes: ['node-footer-heading', 'node-footer-text'],
    linkedNodes: {},
  },
  'node-footer-heading': {
    type: { resolvedName: 'Heading' },
  ...
  'node-footer-text': {
    ...
    isCanvas: false,
    props: {
      content: 'All are welcome at our services. Come experience the peace of Orthodox worship.',
      align: 'center',
      size: 'md',
      textColor: '#C0B8AC',
    },
